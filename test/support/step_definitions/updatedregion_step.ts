...
beforeEach(() => {
        ...
        //  utilityclear.getQueryResponse(TEST_QUERY_GET_COUNTRY,'sample')
        //  utilityclear.deleteAutomationRecords(TEST_MUTATION_DELETE_COUNTRY,'3b4a891f-28b6-4168-aa4b-6c61223b00c1')
        //  utilityclear.deleteCountry('sample')
        //  utilityclear.deleteCountry('3b4a891f-28b6-4168-aa4b-6c61223b00c1')
...
{
    cy.get('[data-cy="addCountryButton"]', { timeout: 20000 }).click() 
